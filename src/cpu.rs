...
macro_rules! instructions {
    ($cont:ident) => {
        $cont! {
            ...
            0x80:*NOP IMM, 0x81: STA INX, 0x82: UNK UNK, 0x83:*SAX INX,
            ...
            0xC0: CPY IMM, 0xC1: CMP INX, 0xC2: UNK UNK, 0xC3:*DCP INX,
            ...
            0xE0: CPX IMM, 0xE1: SBC INX, 0xE2: UNK UNK, 0xE3:*ISB INX,
...
impl Cpu {
    ...
    fn exec_one(&mut self) {
        ...
        macro_rules! exec_op {
            ...
            (SAX, $addr:ident) => {{
                self.write_u8($addr, self.reg.a & self.reg.x);
            }};
            (DCP, $addr:ident) => {{
