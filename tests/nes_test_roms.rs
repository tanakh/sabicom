...
test_roms! {
    ...
    ppu_vbl_nmi_01_vbl_basics => "nes-test-roms/ppu_vbl_nmi/rom_singles/01-vbl_basics.nes",
    ppu_vbl_nmi_02_vbl_set_time => "nes-test-roms/ppu_vbl_nmi/rom_singles/02-vbl_set_time.nes",
    ppu_vbl_nmi_03_vbl_clear_time => "nes-test-roms/ppu_vbl_nmi/rom_singles/03-vbl_clear_time.nes",
    ppu_vbl_nmi_04_nmi_control => "nes-test-roms/ppu_vbl_nmi/rom_singles/04-nmi_control.nes",
    ppu_vbl_nmi_05_nmi_timing => "nes-test-roms/ppu_vbl_nmi/rom_singles/05-nmi_timing.nes",
    ppu_vbl_nmi_06_supression => "nes-test-roms/ppu_vbl_nmi/rom_singles/06-suppression.nes",
    ppu_vbl_nmi_07_nmi_on_timing => "nes-test-roms/ppu_vbl_nmi/rom_singles/07-nmi_on_timing.nes",
